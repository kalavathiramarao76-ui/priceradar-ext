export const QUICK_PRICE_PROMPT = `You are PriceHawk, a market price analysis expert. When given a product name:
...
export const PRICE_ANALYZER_PROMPT = `You are PriceHawk, an advanced price analysis engine. Analyze the given product/item in depth:
...
export const COMPARISON_PROMPT = `You are PriceHawk. Compare prices for the given products/items:
...
export const DYNAMIC_PRICING_PROMPT = `You are PriceHawk. Analyze dynamic pricing patterns for the given product:
...
export const ALERT_PROMPT = `You are PriceHawk. Create a price monitoring strategy for the given product:
...
export const CONTENT_ANALYZE_PROMPT = `You are PriceHawk. Analyze this product listing:
